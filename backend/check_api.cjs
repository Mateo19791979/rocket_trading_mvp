...
${colors?.green}Usage:${colors?.reset} node check_api.cjs [options]
...
${colors?.green}Examples:${colors?.reset}
  node check_api.cjs
  node check_api.cjs --timeout=10000 --verbose
  node check_api.cjs --api-base=https://custom-api.com
  node check_api.cjs --retries=5
